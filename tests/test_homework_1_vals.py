...
def test_factorial(query: dict[str, Any], status_code: int, result: int):
...
def test_fibonacci(params: str, status_code: int, result: int):
...
def test_mean(json: dict[str, Any] | None, status_code: int, result: float):
